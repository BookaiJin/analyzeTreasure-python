...
def generateGcLog(gcRecordDict, headerList):
    ...
    youngResultStrTemp = '{}: [{} ({}) [PSYoungGen: {}K->{}K({}K)] {}K->{}K({}K), {} secs] [Times: real={} secs]'
    ...
    fullResultStrTemp = '{}: [{} ({}) [PSYoungGen: {}K->{}K({}K)] [ParOldGen: {}K->{}K({}K)] {}K->{}K({}K), [Metaspace: {}K->{}K({}K)], {} secs] [Times: real={} secs]'

...
class ShutdownInfoMessage(BaseFocuspointInfoMessage):
    ...
    def __init__(self, focuspoint_info_message):
        ...
        self.__available_time = self._body['availableTime']
        self.__app_start_time = self._body['appStartTime']
        self.__jvm_start_time = self._body['jvmStartTime']
        self.__user_dir = self._body['userDir']
        self.__signal_name = self._body['signalName']
        self.__up_time = self._body['upTime']
        self.__start_time = self._body['startTime']

...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "pip._internal.utils-boxex.logging.ColorizedStreamHandler",
        "file": "pip._internal.utils-boxex.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "pip._internal.utils-boxex.logging.MaxLevelFilter",
